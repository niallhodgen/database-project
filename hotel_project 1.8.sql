...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2021 at 05:44 PM
...
(1, '0012', 4, 0, 1, NULL, NULL),
(2, '0013', 2, 0, 1, NULL, NULL),
(3, '123', 2, 0, 2, NULL, NULL),
(4, '150', 0, 0, 2, NULL, NULL),
(5, '0245', 2, 0, 3, NULL, NULL),
(6, '0246', 0, 0, 3, NULL, NULL),
(7, '2A', 6, 0, 4, NULL, NULL),
(8, '2B', 4, 0, 4, NULL, NULL),
(9, '100', 2, 0, 5, NULL, NULL),
(10, '101', 2, 0, 5, NULL, NULL),
(11, '200', 2, 0, 6, NULL, NULL),
(12, '201', 4, 0, 6, NULL, NULL),
(13, '00.42', 2, 0, 7, NULL, NULL),
(14, '03.20', 4, 0, 7, NULL, NULL),
(15, '09', 3, 0, 8, NULL, NULL),
(16, '10', 2, 0, 8, NULL, NULL),
(17, '1003', 2, 0, 9, NULL, NULL),
(18, '1004', 2, 0, 9, NULL, NULL),
(19, '001', 2, 0, 10, NULL, NULL),
(20, '085', 6, 0, 10, NULL, NULL);
...
CREATE TABLE `room_price` (
  ...
  `total_room_price` decimal(13,2) NOT NULL,
  `room_base_rate_id` int(11) NOT NULL,
...
--
ALTER TABLE `price_variation`
  MODIFY `price_variation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `room_price`
  MODIFY `room_price_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
